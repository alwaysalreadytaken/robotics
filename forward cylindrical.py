...
def F_cylindrical(theta_1,d2,d3):
    C20=rotate_z(theta_1)
    P0=0
    P1=P0+A_l0*z0
    P2=P1+d2*z0
    P3=P2+d3*np.dot(C20,y0)
    return P0,P1,P2,P3
...
p0,p1,p2,p3=F_cylindrical(90,10,5)
print(p0,p1,p2,p3)
theta_1,d2,d3=I_cylindrical(p3[0],p3[1],p3[2])
print(theta_1,d2,d3)
...
slider2= Slider(theta2, r'd2', 0,  20.0, valinit=0)
slider3= Slider(theta3, r'd3', 0,  20.0, valinit=0)
def update(val):
    for txt in ax.texts:
    ...
    s2 = slider2.val
    s3 = slider3.val
    p0,p1,p2,p3=F_cylindrical(s1,s2,s3)
