...
theta_1,theta_2,theta_3=I_articulated(5,10,25)
p0,p1,p2,p3,p4=F_articulated(theta_1,theta_2,theta_3)
...
slider1= Slider(theta1, r'X', -15,15, valinit=5)
slider2= Slider(theta2, r'Y', -15,15, valinit=10)
slider3= Slider(theta3, r'Z',   0,30, valinit=25)
def update(val):
    for txt in ax.texts:
    ...
    s2 = slider2.val
    s3 = slider3.val
    theta_1,theta_2,theta_3=I_articulated(s1,s2,s3)
    p0,p1,p2,p3,p4=F_articulated(theta_1,theta_2,theta_3)
