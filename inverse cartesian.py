...
d1,d2,d3=I_cartesian(10,10,10)
print(d1,d2,d3)
p0,p1,p2,p3=F_cartesian(d1,d2,d3)
print(p0,p1,p2,p3)
...
slider1= Slider(theta1, r'X', 0,  20.0, valinit=10)
slider2= Slider(theta2, r'Y', 0,  20.0, valinit=10)
slider3= Slider(theta3, r'Z', 0,  20.0, valinit=10)
def update(val):
    for txt in ax.texts:
